...
#
#
# sort_file1(pathlib.Path(r"D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test_sort_file")
...
#
#
# sort_file(r"D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test_sort_file")


CATEGORIES_DICT = {
    'Videos': ['.mp4', '.avi', '.mov', '.flv', '.aaf', '.mkv', '.wmv',
               '.mpeg'],
...
def move_file(source_path: str, file_name: str, file_category: str):
    ...
    if not (os.path.exists(new_file_destination) and os.path.isdir(
...
def moved_files_report(report_dict: dict):
    ...
    if report_dict:
        ...
        print(
            'Файлы не были перемещены. Возможно, нет файлов для перемещения.')


if __name__ == "__main__":
    # create_files(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test-test', '.txt', 4)
    # create_files(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test-test', '.doc', 4)
    # create_files(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test-test', '.mp3', 4)
    # create_files(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test-test', '.wav', 4)
    # create_files(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test-test', '.mkv', 4)
    # create_files(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test-test', '.json', 4)
    # create_files(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test-test', '.mp4', 4)
    sort_files_by_folders(
        r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test-test')
