...
if __name__ == '__main__':
    create_files(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test_rename',
        '.txt',4)
    # create_files(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test_rename',
    # '.json', 2)
    # create_files(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test_rename',
    ...
    # вывод на печать сгенерированных имен, для проверки,
    # правильно ли выбираются нужные символы.
    files = os.listdir(r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test_rename')
    for file in files:
        print(file)

    batch_rename('NEW_', 3, '.txt', '.md', [0, 3],
                 r'D:\Курсы\GeekBrains\Погружение в Python\Homework_7\test_rename')
